...
public class PaymentManage extends ListActivity {
	...
	protected void onListItemClick(ListView l, View v, int position, long id) {
		...
		if (id == 0) {
			payment_intent.setClass(PaymentManage.this, PaymentSelfService.class);
		}else if(id==1){
			payment_intent.setClass(PaymentManage.this, PaymentManage.class);
		}else if(id==2){
			payment_intent.setClass(PaymentManage.this, PaymentLastMonth.class);
		}else if(id==3){
			payment_intent.setClass(PaymentManage.this, PaymentHistory.class);
		}else if(id==4){
			payment_intent.setClass(PaymentManage.this, PaymentDefAcc.class);
		}
	}
}