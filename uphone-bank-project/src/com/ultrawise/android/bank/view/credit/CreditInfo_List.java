...
public class CreditInfo_List extends ListActivity {
	...
	private String creditNo=null;
	 public void onCreate(Bundle savedInstanceState) {
	        ...
	        map4.put("creditinfo_key", "每月到账单日");
	 	...
	 	class TransactiondetailsImageButtonListener implements OnClickListener{
			...
			public void onClick(View arg0) {
				...
				transDetailInfo1.put("交易日期", "2010年12月25日");
				...
				transDetailInfo2.put("交易日期", "2011年1月25日");
				transDetailInfo2.put("交易类型", "水费");
				transDetailInfo2.put("交易金额","100");
